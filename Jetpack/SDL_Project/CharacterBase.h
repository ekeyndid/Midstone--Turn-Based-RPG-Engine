...
public:
	...
	void TakeDmg(float value) { CurrHP -= value; } //take damage
	 // deal damage (probably will be yeeted. Idk.)
	virtual void SetHP(float value1, float value2) { CurrHP = value1; CurrMP = value2; }//set current hp to float set current mp to float
